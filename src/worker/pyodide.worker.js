    ...
    try:
        ...
        if 'OUTPUT_HTML' in globals() and globals()['OUTPUT_HTML']:
            ...
            if hasattr(val, 'to_html'):
                ...
                val = pio.to_html(val, include_plotlyjs='cdn', full_html=False, config={'responsive': True, 'displayModeBar': False})
...
pio.to_html(fig, include_plotlyjs='cdn', full_html=False, config={'responsive': True, 'displayModeBar': False})
                `);
